...
{ label: "Enterprise rental car (Denali)", amount: 233.77 },
...
{ label: "Hoonah / Icy Strait Point", amount: 4.46 },
{ label: "Juneau (May 12) — food & gas", amount: 88.13 },
{ label: "Explore Juneau rental car", amount: 230.00 },
{ label: "Recreation.gov — Denali permits", amount: 30.00 },
{ label: "Seward port — Easypark", amount: 3.15 },
{ label: "Denali drive — Carrs groceries", amount: 85.36 },
{ label: "Anchorage — Humpys, Starbucks, 49th State", amount: 229.30 },
{ label: "Healy — Thai dinner + Vitus gas", amount: 90.01 },
{ label: "Denali — gift shops + park assoc.", amount: 111.83 },
{ label: "ANC layover — Aramark", amount: 23.29 },
{ label: "MIA return — parking", amount: 4.40 },
],
sections: [
{
id: "cruise",
...
"Spent today: $88.13 (Red Spruce, Forbidden Peak, Safeway, gas) · car rental $230.00",
],
status: "booked",
},
{
