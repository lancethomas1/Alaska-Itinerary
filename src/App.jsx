...
{
date: "May 16",
day: "Denali Ground Day",
location: "Denali National Park",
icon: "🐻",
weather: { icon: "⛅", hi: 51, lo: 40, desc: "Mostly cloudy, dry. Good day for ground exploration — flightseeing rescheduled to May 17 at noon. (NWS Denali Park)" },
astro: { sunrise: "4:42 AM", sunset: "11:01 PM", moon: "🌑", phase: "New Moon" },
items: [
"⚠️ FLIGHTSEEING RESCHEDULED to May 17 at 12:00 PM (Res. IOR0BL still valid)",
"10:00 AM — Sled Dog Demo (free) at Mile 3 kennels — moved up from May 17",
"Midday: Savage River Loop (Mile 15) — open zone, wildlife hike",
"PM: Horseshoe Lake Trail or Riley Creek trails near park entrance",
"Early night at Grande Denali Lodge — pack out tonight for tomorrow's noon flight",
],
status: "booked",
},
{
date: "May 17",
day: "Flightseeing & Depart",
location: "Denali → Anchorage",
icon: "🛩️",
weather: { icon: "🌦️", hi: 50, lo: 38, desc: "Slight chance of showers after 10 AM — Fly Denali will assess pre-flight. Drive south stays mostly dry. (NWS Denali Park)" },
astro: { sunrise: "4:57 AM", sunset: "10:47 PM", moon: "🌑", phase: "New Moon" },
items: [
"Morning: Check out of Grande Denali Lodge by 11 AM — finish packing, light breakfast",
"~11:15 AM — Free shuttle from lodge to Healy River Airport · Fly Denali check-in",
"✅ 12:00 PM — Fly Denali Glacier Landing (Res. IOR0BL) — 100 min + 20–30 min on Ruth Glacier",
"~2:45 PM — Wheels down at Healy · grab-and-go lunch, hit the road",
"~3:00 PM — Begin drive south on Parks Hwy (~4 hr to ANC)",
"~4:30 PM — Denali Viewpoint South (Mile 134–135) — quick 10 min photo stop",
"⚠️ Skip Talkeetna detour — too tight for 8:45 PM flight",
"~7:30 PM — ANC airport · ⚠️ Call Enterprise to extend return past 7 PM",
"Fly UA267 ANC→ORD 8:45 PM",
],
status: "booked",
},
],
...
{ id: 16, text: "Fly Denali Glacier Landing booked — Res. IOR0BL (rescheduled to May 17 noon)", done: true, priority: "high" },
{ id: 17, text: "Call Enterprise to extend May 17 return past 7 PM (now ~7:30 PM ANC arrival)", done: false, priority: "high" },
],
};
